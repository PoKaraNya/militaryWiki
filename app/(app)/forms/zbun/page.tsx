...
import {
  ...
  positiveNum,
  required,
} from '@/config/zbunFormValidation'
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="ZbunForm">
      <div className="block">
        ...
        <InputWrapper
          ...
          validation={mail}
        />
        <InputWrapper placeholder="Телефон" name="phone" validation={phone} />
      </div>
      ...
      <div className="container">
        <div className="block block-short">
          ...
          <div>
            <label htmlFor="loading_person">Особа</label>
            <select
        ...
        <div className="block block-short">
          ...
          />
          <div>
            <label htmlFor="unloading_person">Особа</label>
            <select
